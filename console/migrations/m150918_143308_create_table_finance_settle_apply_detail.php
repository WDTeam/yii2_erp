...
class m150918_143308_create_table_finance_settle_apply_detail extends Migration
{
    public function up()
    {
        $tableOptions = null;
        ...
        $this->createTable('{{%finance_settle_apply_detail}}', [
    ...
    {
        $this->dropTable('{{%finance_settle_apply_detail}}');
    }
