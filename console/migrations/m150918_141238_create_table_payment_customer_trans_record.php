...
class m150918_141238_create_table_payment_customer_trans_record extends Migration
{
    ...
    public function up()
    {
        ...
        $this->createTable('{{%payment_customer_trans_record}}', [
            ...
            'payment_customer_trans_record_coupon_money'  => Schema::TYPE_DECIMAL . '(5,2) unsigned  DEFAULT 0 COMMENT \'优惠券金额\'',
            'payment_customer_trans_record_cash'  => Schema::TYPE_DECIMAL . '(5,2) unsigned  DEFAULT 0 COMMENT \'现金支付\'',
            'payment_customer_trans_record_pre_pay'  => Schema::TYPE_DECIMAL . '(5,2) unsigned  DEFAULT 0 COMMENT \'预付费金额（第三方）\'',
            'payment_customer_trans_record_online_pay'  => Schema::TYPE_DECIMAL . '(5,2) unsigned  DEFAULT 0 COMMENT \'在线支付\'',
            'payment_customer_trans_record_online_balance_pay'  => Schema::TYPE_DECIMAL . '(5,2) unsigned  DEFAULT 0 COMMENT \'在线余额支付\'',
            'payment_customer_trans_record_service_card_on'  => Schema::TYPE_STRING . '(30)  DEFAULT 0 COMMENT \'服务卡号\'',
            'payment_customer_trans_record_service_card_pay'  => Schema::TYPE_DECIMAL . '(7,2) unsigned DEFAULT 0 COMMENT \'服务卡支付\'',
            'payment_customer_trans_record_service_card_current_balance'  => Schema::TYPE_DECIMAL . '(8,2) NOT NULL DEFAULT 0 COMMENT \'服务卡当前余额\'',
            'payment_customer_trans_record_service_card_befor_balance'  => Schema::TYPE_DECIMAL . '(8,2) NOT NULL DEFAULT 0 COMMENT \'服务卡之前余额\'',
            ...
            'payment_customer_trans_record_order_total_money'  => Schema::TYPE_DECIMAL . '(7,2) unsigned NOT NULL DEFAULT 0 COMMENT \'订单总额\'',
