...
class m150918_141238_create_table_payment_customer_trans_record extends Migration
{
    ...
    public function up()
    {
        ...
        $this->createTable('{{%payment_customer_trans_record}}', [
            ...
            'order_id' => Schema::TYPE_STRING . '(30) unsigned DEFAULT 0 NOT NULL COMMENT \'订单ID\'' ,
            ...
            'payment_customer_trans_record_order_total_money'  => Schema::TYPE_DECIMAL . '(8,2) unsigned NOT NULL DEFAULT 0 COMMENT \'订单总额\'',
