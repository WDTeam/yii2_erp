...
class m150918_125452_create_table_finance_order_channel extends Migration
{
    ...
    public function up()
    {
        ...
        $this->execute(
            "INSERT INTO {{%finance_order_channel}} VALUES ('1', '11', 'APP微信（客户端）', 1, 1, 1443339882, '0');
             ...
             INSERT INTO {{%finance_order_channel}} VALUES ('7', '8', 'H5百度直达号（@e家洁）', 7, 1, 1443339882, '0');
             ...
             INSERT INTO {{%finance_order_channel}} VALUES ('13', '5', '支付宝服务窗', 13, 1,1443339882, '0');
             ...
             INSERT INTO {{%finance_order_channel}} VALUES ('19', '1', '美团团购', 19, 1, 1443339882, '0');
             INSERT INTO {{%finance_order_channel}} VALUES ('20', '14', '后台下单', 20, 1, 1443339882, '0');
			  INSERT INTO {{%finance_order_channel}} VALUES ('21', '15', '新浪微博', 21, 1, 1443339882, '0');"
        );
    }
