...
class m151115_105422_create_table_finance_worker_cannot_settle_order extends Migration
{
   public function up()
    {
        $tableOptions = null;
        if ($this->db->driverName === 'mysql') {
            $tableOptions = 'CHARACTER SET utf8 COLLATE utf8_general_ci ENGINE=InnoDB COMMENT=\'阿姨不能结算订单表\'';
        }
        $this->createTable('{{%finance_worker_cannot_settle_order}}', [
    ...
    {
        $this->dropTable('{{%finance_worker_cannot_settle_order}}');
        return true;
    }
}
