...
class m150918_132800_ejj_user extends Migration
{
    public function up()
    {
        ...
        $this->createTable('{{%user}}', [
            ...
            'user_name'=>  Schema::TYPE_STRING.'(16) NOT NULL COMMENT \'客户名称\'',
            'user_sex' => Schema::TYPE_SMALLINT.'(4) NOT NULL',
            'user_birth'=>  Schema::TYPE_INTEGER.'(11) NULL DEFAULT NULL COMMENT \'客户生日\'',
            'user_photo'=>  Schema::TYPE_STRING.'(32) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT \'客户头像\'',
            'user_phone' => Schema::TYPE_STRING.'(11) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT \'客户手机号\'',
            'user_email'=>  Schema::TYPE_STRING.'(32) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT \'客户邮箱\'',
            'region_id'=>  Schema::TYPE_INTEGER.'(8) NULL DEFAULT NULL COMMENT \'居住区域关联\'',
            'user_live_address_detail'=>  Schema::TYPE_STRING.'(64) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL',
            ...
            'user_login_ip'=> Schema::TYPE_STRING.'(16) DEFAULT NULL',
