...
class m150919_092739_create_table_worker extends Migration
{
    public function up()
    {
        ...
        $this->createTable('{{%worker}}', [
            ...
            'worker_rule' => Schema::TYPE_BOOLEAN  . '(1) NOT NULL DEFAULT 1 COMMENT \'阿姨角色 1自有 2非自有\'',
            'worker_identify_id' => Schema::TYPE_BOOLEAN  . '(3) NOT NULL  DEFAULT  1 COMMENT \'阿姨身份id \'',
