...
class m150918_141440_create_table_fi_invoice extends Migration
{
 public function up()
    {
    if ($this->db->driverName === 'mysql') {
    	...
    	$this->createTable('{{%fi_invoice}}', [
    			...
    			'fi_invoice_pay_status' => Schema::TYPE_SMALLINT. '(1) DEFAULT NULL COMMENT \'支付状态\'',
    			'admin_confirm_uid' => Schema::TYPE_SMALLINT. '(4) DEFAULT NULL COMMENT \'确认人\'',
    			'fi_invoice_enrolment_time' => Schema::TYPE_INTEGER. '(10) DEFAULT NULL COMMENT \'申请时间\'',
    			...
    			'fi_invoice_corp_email' => Schema::TYPE_STRING. '(40) DEFAULT NULL COMMENT \'邮箱\'',
    			'fi_invoice_corp_address' => Schema::TYPE_STRING. '(200) DEFAULT NULL COMMENT \'公司地址\'',
    			'fi_invoice_corp_name' => Schema::TYPE_STRING. '(150) DEFAULT NULL COMMENT \'公司名称\'',
    			'fi_invoice_district_id' => Schema::TYPE_SMALLINT. '(4) DEFAULT NULL COMMENT \'城市id\'',
