    ...
    public function up()
    {
        \Yii::$app->db->createCommand("
            CREATE TABLE {{%system_user}} (
              ...
              `username` varchar(255) COLLATE utf8_unicode_ci COMMENT '用户名',
              `auth_key` varchar(32) COLLATE utf8_unicode_ci,
              `password_hash` varchar(255) COLLATE utf8_unicode_ci COMMENT '加密密文',
