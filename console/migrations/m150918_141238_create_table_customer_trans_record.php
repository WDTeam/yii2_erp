...
class m150918_141238_create_table_customer_trans_record extends Migration
{
    ...
    public function up()
    {
        ...
        $this->createTable('{{%customer_trans_record}}', [
            ...
            'customer_trans_record_online_service_card_pay'  => Schema::TYPE_DECIMAL . '(7,2) unsigned NOT NULL DEFAULT 0 COMMENT \'服务卡支付\'',
            ...
            'customer_trans_record_compensate_money'  => Schema::TYPE_DECIMAL . '(8,2) unsigned NOT NULL DEFAULT 0 COMMENT \'补偿金额\'',
            'customer_trans_record_refund_money'  => Schema::TYPE_DECIMAL . '(8,2) unsigned NOT NULL DEFAULT 0 COMMENT \'退款金额\'',
