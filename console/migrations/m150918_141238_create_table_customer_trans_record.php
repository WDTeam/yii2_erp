...
class m150918_141238_create_table_customer_trans_record extends Migration
{
    ...
    public function up()
    {
        ...
        $this->createTable('{{%customer_trans_record}}', [
            ...
            'customer_trans_record_mode'  => Schema::TYPE_BOOLEAN . '(4) unsigned NOT NULL DEFAULT 0 COMMENT \'交易方式:1消费,2=充值,3=退款,4=赔偿\'',
            'customer_trans_record_mode_name'  => Schema::TYPE_STRING . '(20) COMMENT \'交易方式名称\'',
            'customer_trans_record_promo_code_money'  => Schema::TYPE_DECIMAL . '(5,2) unsigned  DEFAULT 0 COMMENT \'优惠码金额\'',
            'customer_trans_record_coupon_money'  => Schema::TYPE_DECIMAL . '(5,2) unsigned  DEFAULT 0 COMMENT \'优惠券金额\'',
            'customer_trans_record_cash'  => Schema::TYPE_DECIMAL . '(5,2) unsigned  DEFAULT 0 COMMENT \'现金支付\'',
            'customer_trans_record_pre_pay'  => Schema::TYPE_DECIMAL . '(5,2) unsigned  DEFAULT 0 COMMENT \'预付费金额（第三方）\'',
            'customer_trans_record_online_pay'  => Schema::TYPE_DECIMAL . '(5,2) unsigned  DEFAULT 0 COMMENT \'在线支付\'',
            'customer_trans_record_online_balance_pay'  => Schema::TYPE_DECIMAL . '(5,2) unsigned  DEFAULT 0 COMMENT \'在线余额支付\'',
            'customer_trans_record_online_service_card_on'  => Schema::TYPE_STRING . '(30)  DEFAULT 0 COMMENT \'服务卡号\'',
            'customer_trans_record_online_service_card_pay'  => Schema::TYPE_DECIMAL . '(7,2) unsigned DEFAULT 0 COMMENT \'服务卡支付\'',
            'customer_trans_record_online_service_card_current_balance'  => Schema::TYPE_DECIMAL . '(8,2) NOT NULL DEFAULT 0 COMMENT \'服务卡当前余额\'',
            ...
            'customer_trans_record_befor_balance'  => Schema::TYPE_DECIMAL . '(8,2) NOT NULL DEFAULT 0 COMMENT \'之前余额\'',
