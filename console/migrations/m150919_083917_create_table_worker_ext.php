...
class m150919_083917_create_table_worker_ext extends Migration
{
    public function up()
    {
        ...
        $this->createTable('{{%worker_ext}}', [
            ...
            'worker_height' => Schema::TYPE_SMALLINT. '(4) DEFAULT 0 COMMENT \'阿姨身高(cm)\'',
            ...
            'worker_bank_from' => Schema::TYPE_STRING . '(40) DEFAULT NULL COMMENT \'银行卡开户网点\'',
            'worker_bank_area' => Schema::TYPE_STRING . '(40) DEFAULT NULL COMMENT \'银行开户地\'',
