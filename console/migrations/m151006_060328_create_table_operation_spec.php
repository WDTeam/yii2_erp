...
class m151006_060328_create_table_operation_spec extends Migration
{
    public function up()
    {
        ...
        $this->execute(
            "INSERT INTO {{%operation_spec}} (`id`, `operation_spec_name`, `operation_spec_description`, `operation_spec_values`, `created_at`, `updated_at`) VALUES
	        (2, '颜色', '颜色备注', 'a:3:{i:0;s:3:\"红\";i:1;s:3:\"蓝\";i:2;s:3:\"绿\";}', 1444136384, 1444225018),
	        (3, 'iphone', 'iphone备注', 'a:4:{i:0;s:12:\"16G合约机\";i:1;s:15:\"32G非合约机\";i:2;s:11:\"64合约机\";i:3;s:13:\"128G合约机\";}', 1444136584, 1444138455);"
        );
    }
