...
class m150918_140930_create_table_finance_settle_apply extends Migration
{
    public function up()
    {
        ...
        $this->createTable('{{%finance_settle_apply}}', [
            ...
            'finance_settle_apply_order_cash_money' => Schema::TYPE_DECIMAL . '(10,2)  COMMENT \'收取的现金\'',
            ...
            'finance_settle_apply_starttime' => Schema::TYPE_INTEGER . '(10)  COMMENT \'结算开始时间\'',
            'finance_settle_apply_endtime' => Schema::TYPE_INTEGER . '(10)  COMMENT \'结算结束时间\'',
        ...
        $this->batchInsert('{{%finance_settle_apply}}',
            ...
            [
                [1,111,'13888888888',2,'全职',220,6,150,0,70,0,2,'魏北南',time(),date("Y-m-d",strtotime("-1 month")),0,time(),time()],
                [2,222,'13899999999',1,'兼职',200,8,200,0,0,0,1,'潘高峰',time(),date("Y-m-d",strtotime("-1 week")),0,time(),time()],
                [3,333,'13899999999',1,'兼职',250,10,250,0,0,0,1,'李胜强',time(),date("Y-m-d",strtotime("-1 week")),0,time(),time()],
            ]);
    }
