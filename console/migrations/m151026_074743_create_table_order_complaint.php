...
class m151026_074743_create_table_order_complaint extends Migration
{
    public function safeUp()
    {
    	...
    	$this->createTable('{{%order_complaint}}',[
    			...
    			'complaint_status'=> Schema::TYPE_SMALLINT.'(2) DEFAULT NULL COMMENT \'投诉状态\'',
    			'complaint_channel'=> Schema::TYPE_SMALLINT.'(2) DEFAULT NULL COMMENT \'投诉渠道\'',
    			...
    			'complaint_phone' => Schema::TYPE_STRING.'(16) NOT NULL COMMENT \'投诉手机号\'',
