...
class m151005_090605_create_table_operation_specifications_goods extends Migration
{
    public function Up()
    {
        ...
        $this->createTable('{{%operation_specifications_goods}}', [
            ...
            'operation_specifications_goods_no' => Schema::TYPE_STRING . '(20) DEFAULT NULL COMMENT \'商品规格货号\'',
            ...
            'operation_specifications_goods_price' => Schema::TYPE_MONEY . ' DEFAULT 0 COMMENT \'商品价格\'',
            'operation_specifications_goods_settlement_price' => Schema::TYPE_MONEY . ' DEFAULT 0 COMMENT \'商品结算价格\'',
