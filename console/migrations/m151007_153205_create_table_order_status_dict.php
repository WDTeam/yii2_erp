...
class m151007_153205_create_table_order_status_dict extends Migration
{
    public function up()
    {
        ...
        $this->batchInsert('{{%order_status_dict}}',
            ...
            [
                [1, '已创建','初始化','待支付','',YII_BEGIN_TIME,YII_BEGIN_TIME,0],
                [2, '待指派','待指派','待指派','',YII_BEGIN_TIME,YII_BEGIN_TIME,0],
                [3, '已开始智能指派','智能指派中','指派中','待接单',YII_BEGIN_TIME,YII_BEGIN_TIME,0],
                [4, '已完成智能指派','待服务','待服务','已接单',YII_BEGIN_TIME,YII_BEGIN_TIME,0],
                [5, '未完成智能指派','智能分单中','指派中','待接单',YII_BEGIN_TIME,YII_BEGIN_TIME,0],
                [6, '已开始人工指派','人工派单中','指派中','待接单',YII_BEGIN_TIME,YII_BEGIN_TIME,0],
                [7, '已完成人工指派','待服务','待服务','已接单',YII_BEGIN_TIME,YII_BEGIN_TIME,0],
                [8, '未完成人工指派','人工派单失败','指派中','待接单',YII_BEGIN_TIME,YII_BEGIN_TIME,0],
                [9, '阿姨已抢单','待服务','待服务','已接单',YII_BEGIN_TIME,YII_BEGIN_TIME,0],
                [10, '已开始服务','服务中','服务中','服务中',YII_BEGIN_TIME,YII_BEGIN_TIME,0],
                [11, '已完成服务','服务完成','服务完成请评价','服务完成待评价',YII_BEGIN_TIME,YII_BEGIN_TIME,0],
                [12, '已完成评价','客户已确认','评价已完成','客户已完成评价',YII_BEGIN_TIME,YII_BEGIN_TIME,0],
                //[13, '已核实订单','财务已对账','评价已完成','已核实结算请求-打款中',YII_BEGIN_TIME,YII_BEGIN_TIME,0], //包括 第三方已对账
                [13, '已完成结算','工人已结算','评价已完成','已完成结算-打款完毕-请查收',YII_BEGIN_TIME,YII_BEGIN_TIME,0],
                [14, '已取消','已取消','已关闭','已取消',YII_BEGIN_TIME,YII_BEGIN_TIME,0],
                [15, '已归档','','','',YII_BEGIN_TIME,YII_BEGIN_TIME,0],
            ]
        );
    }
