...
class m151007_153205_create_table_order_status_dict extends Migration
{
    public function up()
    {
        ...
        $this->batchInsert('{{%order_status_dict}}',
            ...
            [
                [1, '已创建','初始化','待支付','待支付',YII_BEGIN_TIME,YII_BEGIN_TIME,0],
                [2, '待指派','待指派','待指派','待指派',YII_BEGIN_TIME,YII_BEGIN_TIME,0],
                [3, '已开始智能指派','智能指派中','待指派','待指派',YII_BEGIN_TIME,YII_BEGIN_TIME,0],
                [4, '已完成智能指派','待服务','待服务','待服务',YII_BEGIN_TIME,YII_BEGIN_TIME,0],
                [5, '未完成智能指派','智能分单中','待指派','待指派',YII_BEGIN_TIME,YII_BEGIN_TIME,0],
                [6, '已开始人工指派','人工派单中','待指派','待指派',YII_BEGIN_TIME,YII_BEGIN_TIME,0],
                [7, '已完成人工指派','待服务','待服务','待服务',YII_BEGIN_TIME,YII_BEGIN_TIME,0],
                [8, '未完成人工指派','人工派单失败','待指派','待指派',YII_BEGIN_TIME,YII_BEGIN_TIME,0],
