...
class m150918_131138_create_table_order_timeline extends Migration
{
    public function up()
    {
        $tableOptions = null;
        ...
        $this->createTable('{{%order_timeline}}', [
              ...
              'order_id'=> Schema::TYPE_INTEGER.'(10) unsigned NOT NULL DEFAULT 0 COMMENT \'订单ID\'',
              'order_parent_id'=> Schema::TYPE_INTEGER.'(10) unsigned NOT NULL DEFAULT 0 COMMENT \'父级id\'',
              'order_is_parent'=> Schema::TYPE_SMALLINT.'(1) unsigned NOT NULL DEFAULT 0 COMMENT \'有无子订单\'',
              'created_at'=> Schema::TYPE_INTEGER.'(10) unsigned NOT NULL DEFAULT 0 COMMENT \'创建时间\'',
              'updated_at'=> Schema::TYPE_INTEGER.'(10) unsigned NOT NULL DEFAULT 0 COMMENT \'修改时间\'',
              'order_status'=> Schema::TYPE_SMALLINT.'(4) unsigned NOT NULL DEFAULT 0 COMMENT \'订单状态\'',
              'order_service_type'=> Schema::TYPE_SMALLINT.'(4) unsigned NOT NULL DEFAULT 0 COMMENT \'订单服务类别\'',
              'order_src'=> Schema::TYPE_SMALLINT.'(4) unsigned NOT NULL DEFAULT 0 COMMENT \'订单来源\'',
              ...
              'user_id'=> Schema::TYPE_INTEGER.'(10) unsigned NOT NULL DEFAULT 0 COMMENT \'用户编号\'',
