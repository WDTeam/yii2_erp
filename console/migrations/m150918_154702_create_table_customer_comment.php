...
class m150918_154702_create_table_customer_comment extends Migration
{
    public function up()
    {
        ...
        $this->createTable('{{%customer_comment}}', [
            ...
            'customer_comment_star_rate' => Schema::TYPE_BOOLEAN .'(1) unsigned NOT NULL DEFAULT 0 COMMENT \'评论星级,0为评价,1-5星\'',
            ...
            'a' => Schema::TYPE_BOOLEAN . '(1) unsigned NOT NULL DEFAULT 1 COMMENT \'删除\'',
