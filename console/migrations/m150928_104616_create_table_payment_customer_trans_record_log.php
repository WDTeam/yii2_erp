...
class m150928_104616_create_table_payment_customer_trans_record_log extends Migration
{
    public function up()
    {
        ...
        $this->createTable('{{%payment_customer_trans_record_log}}', [
            ...
            'payment_customer_trans_record_coupon_money' => Schema::TYPE_DECIMAL . "(5,2)  COMMENT '优惠券金额'",
            'payment_customer_trans_record_cash' => Schema::TYPE_DECIMAL . "(5,2)  COMMENT '现金支付'",
            'payment_customer_trans_record_pre_pay' => Schema::TYPE_DECIMAL . "(5,2)  COMMENT '预付费金额（第三方）'",
            'payment_customer_trans_record_online_pay' => Schema::TYPE_DECIMAL . "(5,2)  COMMENT '在线支付'",
            ...
            'payment_customer_trans_record_service_card_pay' => Schema::TYPE_DECIMAL . "(5,2)  COMMENT '服务卡支付'",
            ...
            'payment_customer_trans_record_order_total_money' => Schema::TYPE_DECIMAL . "(5,2)  COMMENT '订单总额'",
