...
class m151028_101442_create_table_operation_service_card_info extends Migration
{
    public function up()
    {
		...
		$this->createTable('{{%operation_service_card_info}}',[
			...
			'service_card_info_card_type' 	=> Schema::TYPE_INTEGER.'(10) NOT NULL DEFAULT 0 COMMENT \'卡类型\'',
			'service_card_info_card_level'	 => Schema::TYPE_INTEGER.'(10) NOT NULL DEFAULT 0 COMMENT \'卡级别\'',
			'service_card_info_par_value' 	=> Schema::TYPE_DECIMAL.'(8,0) NOT NULL DEFAULT 0 COMMENT \'卡面金额\'',
			'service_card_info_reb_value' 	=> Schema::TYPE_DECIMAL.'(8,0) NOT NULL DEFAULT 0 COMMENT \'优惠金额\'',
			'service_card_info_use_scope' 	=> Schema::TYPE_INTEGER.'(10) NOT NULL DEFAULT 0 COMMENT \'使用范围\'',
