...
class m151028_101442_create_table_operation_service_card_info extends Migration
{
    public function up()
    {
		...
		$this->createTable('{{%operation_service_card_info}}',[
			...
			'service_card_info_value' 	=> Schema::TYPE_DECIMAL.'(8,0) NOT NULL DEFAULT 0 COMMENT \'卡面金额\'',
			'service_card_info_rebate_value' 	=> Schema::TYPE_DECIMAL.'(8,0) NOT NULL DEFAULT 0 COMMENT \'优惠金额\'',
