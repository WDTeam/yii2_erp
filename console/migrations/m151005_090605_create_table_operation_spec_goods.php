...
{
    const TB_NAME = '{{%operation_spec_goods}}';
    ...
    public function Up()
    {
        ...
        $this->createTable(self::TB_NAME, [
            ...
            'operation_spec_goods_sell_price' => 'decimal(10,2) DEFAULT 0 COMMENT \'商品销售价格\'',
            'operation_spec_goods_market_price' => 'decimal(10,2) DEFAULT 0 COMMENT \'商品市场价格\'',
            'operation_spec_goods_cost_price' => 'decimal(10,2) DEFAULT 0 COMMENT \'商品成本价格\'',
            'operation_spec_goods_settlement_price' => 'decimal(10,2) DEFAULT 0 COMMENT \'商品结算价格\'',

            'operation_spec_goods_commission_mode' => Schema::TYPE_INTEGER . '(1) DEFAULT 2 COMMENT \'收取佣金方式（1: 百分比 2: 金额）\'',
            'operation_spec_goods_commission' => 'decimal(10,2) DEFAULT 0 COMMENT \'佣金值\'',
