...
class m150919_083707_create_table_worker_schedule extends Migration
{
    public function up()
    {
        ...
        $this->createTable('{{%worker_schedule}}', [
            ...
            'worker_schedule_start_date' => Schema::TYPE_INTEGER . '(10) DEFAULT NULL COMMENT \'开始的小时\'',
            'worker_schedule_end_date' => Schema::TYPE_INTEGER . '(10) DEFAULT NULL COMMENT \'结束的小时\'',
            'worker_schedule_timeline' => Schema::TYPE_TEXT. ' DEFAULT NULL COMMENT \'工作安排日期\'',
