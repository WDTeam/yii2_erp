...
class m150918_075922_create_table_op_category_type extends Migration
{
    public function up(){
        ...
        $this->createTable('{{%op_category_type}}', [
            ...
            'category_type_app_ico' => Schema::TYPE_TEXT . ' DEFAULT NULL COMMENT \'APP端图标(序列化方式存储|首页大图，首页小图，分类页小图，订单页小图)\'',
            'category_type_pc_ico' => Schema::TYPE_TEXT . ' DEFAULT NULL COMMENT \'PC端图标(序列化方式存储|首页推荐大图，更多推荐大图，下单页小图)\'',
