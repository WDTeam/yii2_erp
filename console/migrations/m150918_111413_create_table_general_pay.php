...
class m150918_111413_create_table_general_pay extends Migration
{
    public function up()
    {
        ...
        $this->createTable('{{%general_pay}}', [
            ...
            'general_pay_source' => Schema::TYPE_BOOLEAN . '(3) unsigned DEFAULT 0 NOT NULL COMMENT \'数据来源:1=APP微信,2=H5微信,3=APP百度钱包,4=APP银联,5=APP支付宝,6=WEB支付宝,7=HT淘宝,8=H5百度直达号,9=HT刷卡,10=HT现金,11=HT刷卡\'',
            'general_pay_source_name' => Schema::TYPE_STRING . '(20) NOT NULL COMMENT \'数据来源名称\'' ,
            'general_pay_mode' => Schema::TYPE_BOOLEAN . '(3) unsigned DEFAULT 0 NOT NULL COMMENT \'交易方式:1=充值,2=余额支付,3=在线支付,4=退款,5=赔偿\'' ,
