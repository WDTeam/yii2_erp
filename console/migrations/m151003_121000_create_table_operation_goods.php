...
class m151003_121000_create_table_operation_goods extends Migration
{
    public function up()
    {
        ...
        $this->createTable('{{%operation_goods}}', [
            ...
            'operation_category_ids' => Schema::TYPE_STRING . '(100) DEFAULT NULL COMMENT \'对应服务品类的所有编号以“,”关联\'',
            ...
            'operation_goods_type_pc_ico' => Schema::TYPE_TEXT . ' DEFAULT NULL  COMMENT \'PC端图标(序列化方式存储|首页推荐大图，更多推荐大图，下单页小图)\'',
