...
class m150918_131138_create_table_order_history extends Migration
{
    public function up()
    {
        ...
        $this->createTable('{{%order_history}}', [
            ...
            'order_created_at' => Schema::TYPE_INTEGER.'(11) unsigned  DEFAULT 0 COMMENT \'创建时间\'',
            'order_updated_at' => Schema::TYPE_INTEGER.'(11) unsigned  DEFAULT 0 COMMENT \'修改时间\'',
...
//===============================创建完订单后 不可修改的部分
            'order_service_type_id' => Schema::TYPE_SMALLINT . '(4) unsigned  DEFAULT 0 COMMENT \'订单服务类别ID\'',
            'order_service_type_name' => Schema::TYPE_STRING . '(128)  DEFAULT \'\' COMMENT \'订单服务类别\'',
            ...
            'customer_id' => Schema::TYPE_INTEGER.'(10) unsigned  DEFAULT 0 COMMENT \'用户编号\'',
            'order_ip' => Schema::TYPE_INTEGER.'(10)  DEFAULT 0 COMMENT \'下单IP\'',
            'order_customer_phone' => Schema::TYPE_STRING .'(16)  DEFAULT \'\' COMMENT \'用户手机号\'',
            'order_booked_begin_time' => Schema::TYPE_INTEGER.'(11) unsigned  DEFAULT 0 COMMENT \'预约开始时间\'', //TODO 预约单词待定
            'order_booked_end_time' => Schema::TYPE_INTEGER.'(11) unsigned  DEFAULT 0 COMMENT \'预约结束时间\'',
            'order_booked_count' => Schema::TYPE_INTEGER.'(10) unsigned  DEFAULT 0 COMMENT \'预约服务数量\'',
            'address_id' => Schema::TYPE_INTEGER.'(10) unsigned  DEFAULT 0 COMMENT \'地址ID\'',
            'order_address'=>Schema::TYPE_STRING.'(255)  DEFAULT \'\' COMMENT \'详细地址 包括 联系人 手机号\'',
            'order_unit_money'=>Schema::TYPE_DECIMAL . '(8,0)  DEFAULT 0 COMMENT \'订单单位价格\'', //TODO 订单单位价格
            'order_money' => Schema::TYPE_DECIMAL . '(8,0)  DEFAULT 0 COMMENT \'订单金额\'',
...
//===========================订单支付完成后 指派阿姨
            'order_lock_status' => Schema::TYPE_BOOLEAN.'(1) unsigned  DEFAULT 0 COMMENT \'是否锁定 1锁定 0未锁定\'',
...
//===========================指派工人===》阿姨服务完成后
            ...
            'order_isdel' => Schema::TYPE_BOOLEAN . '(1) unsigned  DEFAULT 0 COMMENT \'是否已删除\'',
