...
class m151105_055318_create_table_customer_ext_balance_log extends Migration
{
    public function up()
    {
        $tableOptions = null;
        ...
        $this->createTable('{{%customer_ext_balance_log}}', [
    ...
    {
        $this->dropTable('{{%customer_ext_balance_log}}');
