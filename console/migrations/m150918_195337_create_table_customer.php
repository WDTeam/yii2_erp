...
class m150918_195337_create_table_customer extends Migration
{
    public function up()
    {
        ...
        $this->createTable('{{%customer}}', [
            ...
            'customer_phone' => Schema::TYPE_STRING.'(11) COMMENT \'电话\'',
            ...
            'customer_score'=>  Schema::TYPE_INTEGER.'(8) COMMENT \'积分\'',
            ...
            'customer_src'=>  Schema::TYPE_SMALLINT.'(4) DEFAULT NULL COMMENT \'来源，1为线下，2为线上\'',
            'channal_id'=>  Schema::TYPE_INTEGER.'(8) DEFAULT NULL COMMENT \'渠道\'',
            'platform_id'=>  Schema::TYPE_INTEGER.'(8) DEFAULT NULL COMMENT \'平台\'',
