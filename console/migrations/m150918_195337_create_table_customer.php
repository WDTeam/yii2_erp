...
class m150918_195337_ejj_customer extends Migration
{
    public function up()
    {
        $tableOptions = null;
        ...
        $this->createTable('{{%customer}}', [
            ...
            'customer_live_address_detail'=>  Schema::TYPE_STRING.'(64) DEFAULT NULL',
            ...
            'customer_login_time'=>  Schema::TYPE_INTEGER.'(11) DEFAULT NULL COMMENT \'登陆 时间\'',
