...
class m151105_101733_create_table_coupon_rule extends Migration
{
    ...
    public function up()
    {
		...
		$this->createTable('{{%coupon_rule}}',[
			...
			'couponrule_type' 		        => Schema::TYPE_STRING.'(40) DEFAULT 0 COMMENT \'实收金额优惠券类型1为全网优惠券2为类别优惠券3为商品优惠券\'',
			...
			'couponrule_customer_type' 		=> Schema::TYPE_INTEGER.'(2) DEFAULT 0 COMMENT \'适用客户类别逗号分割1为所有用户2为新用户3为老用户4会员5为非会员\'',
