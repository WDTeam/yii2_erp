...
class m150918_131148_create_table_order_status extends Migration
{
    public function up()
    {
        ...
        $this->createTable('{{%order_status}}', [
            ...
            'order_status_send_time'  => Schema::TYPE_INTEGER.'(10) unsigned NOT NULL DEFAULT 0 COMMENT \'系统指派中\'',
            'order_status_allot_time'  => Schema::TYPE_INTEGER.'(10) unsigned NOT NULL DEFAULT 0 COMMENT \'待系统分单\'',
            'order_status_labor_send_time'  => Schema::TYPE_INTEGER.'(10) unsigned NOT NULL DEFAULT 0 COMMENT \'人工派单中\'',
...
//====================指派完成
            ...
            'order_status_worker_payout_time'  => Schema::TYPE_INTEGER.'(10) unsigned NOT NULL DEFAULT 0 COMMENT \'工人已结算\'',
