   ...
   static  public function get_adminname($id)
    ...
    public function attributeLabels()
    {
        return [
            ...
            'order_use_promotion_money' => Yii::t('core', '使用促销金额'),
