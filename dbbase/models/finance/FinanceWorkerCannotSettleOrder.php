...
/**
 * This is the model class for table "{{%finance_worker_cannot_settle_order}}".
 *
 * @property integer $id
 ...
 */
class FinanceWorkerCannotSettleOrder extends \yii\db\ActiveRecord
{
    /**
     * @inheritdoc
     */
    ...
    {
        return '{{%finance_worker_cannot_settle_order}}';
    }
    ...
    {
        return [
            [['worker_id', 'order_id', 'order_code', 'order_service_type_id', 'channel_id', 'order_pay_type_id'], 'required'],
            [['worker_id', 'order_id', 'order_service_type_id', 'channel_id', 'order_pay_type_id', 'order_booked_begin_time', 'order_booked_count', 'finance_worker_order_income_starttime', 'finance_worker_order_income_endtime', 'finance_worker_settle_apply_id', 'is_softdel', 'updated_at', 'created_at'], 'integer'],
