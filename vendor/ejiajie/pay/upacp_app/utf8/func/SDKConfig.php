...
// 签名证书路径
const SDK_SIGN_CERT_PATH = 'E:/wamp/www/ejj-enterprise-boss/vendor/ejiajie/pay/upacp_app/PM_700000000000001_acp.pfx';

// 签名证书密码
 const SDK_SIGN_CERT_PWD = '000000';

// 密码加密证书（这条用不到的请随便配）
const SDK_ENCRYPT_CERT_PATH = 'E:/wamp/www/ejj-enterprise-boss/vendor/ejiajie/pay/upacp_app/';

// 验签证书路径（请配到文件夹，不要配到具体文件）
const SDK_VERIFY_CERT_DIR = 'E:/wamp/www/ejj-enterprise-boss/vendor/ejiajie\pay/upacp_app/';
...
//文件下载目录
const SDK_FILE_DOWN_PATH = '/tmp/pay';

//日志 目录
const SDK_LOG_FILE_PATH = '/tmp/pay';
