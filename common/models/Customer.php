...
class Customer extends \yii\db\ActiveRecord
{
    ...
    public function attributeLabels()
    {
        return [
            ...
            'customer_sex' => Yii::t('app', '客户性别'),
            'customer_birth' => Yii::t('app', '客户生日'),
            'customer_photo' => Yii::t('app', '客户头像'),
            'customer_phone' => Yii::t('app', '客户手机号'),
            'customer_email' => Yii::t('app', '客户邮箱'),
            'region_id' => Yii::t('app', '居住区域关联'),
            'customer_live_address_detail' => Yii::t('app', 'Customer Live Address Detail'),
            'customer_score' => Yii::t('app', '用户积分'),
            'customer_level' => Yii::t('app', '客户会员级别'),
            'customer_src' => Yii::t('app', '客户来源，1为线下，2为线上'),
            'channal_id' => Yii::t('app', '关联渠道'),
            'platform_id' => Yii::t('app', '关联平台'),
            'customer_login_ip' => Yii::t('app', '登陆ip'),
            'customer_login_time' => Yii::t('app', '登陆 时间'),
