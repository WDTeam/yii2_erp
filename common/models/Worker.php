...
class Worker extends \yii\db\ActiveRecord
{
    ...
    public function rules()
    {
        return [
            ...
            [['shop_id','worker_photo','worker_name','worker_work_city','worker_phone','worker_idcard','worker_type', 'worker_type','worker_identity_id'],'required'],
            [['shop_id', 'worker_level', 'worker_auth_status', 'worker_ontrial_status', 'worker_onboard_status', 'worker_work_city', 'worker_work_area', 'worker_type', 'worker_rule_id', 'worker_is_block', 'worker_is_blacklist', 'worker_is_dimission','created_ad', 'updated_ad', 'isdel'], 'integer'],
