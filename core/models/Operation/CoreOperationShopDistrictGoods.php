...
//            self::delCityShopDistrictGoods($goodsid, $cityid);
            foreach((array)$shopdistrictinfo as $k => $v){
                ...
                $shop_district_goods_data[$i][] = $settinghopdistrictgoods['operation_goods_start_time'][$k];  //服务开始时间
                $shop_district_goods_data[$i][] = $settinghopdistrictgoods['operation_goods_end_time'][$k];  //服务结束时间
                ...
                $shop_district_goods_data[$i][] = $settinghopdistrictgoods['operation_goods_price'][$k];  //售价
                ...
                $shop_district_goods_data[$i][] = $settinghopdistrictgoods['operation_goods_price'][$k]*$settinghopdistrictgoods['operation_goods_lowest_consume'][$k];  //最低消费价格
                $shop_district_goods_data[$i][] = $settinghopdistrictgoods['operation_goods_lowest_consume'][$k];  //最低消费数量
                
                $shop_district_goods_data[$i][] = $goodinfo['goodscontent'][$goodsid]['operation_goods_price_description'];  //价格备注
                
                $shop_district_goods_data[$i][] = $settinghopdistrictgoods['operation_goods_market_price'][$k];  //市场价格
