...
class PaymentCustomerTransRecord extends \dbbase\models\payment\PaymentCustomerTransRecord
{
    ...
    public static function analysisRecord($data)
    {
        ...
        $data['payment_customer_trans_record_transaction_id'] = !empty($data['general_pay_transaction_id']) ? $data['general_pay_transaction_id'] : 0; //交易流水号
        ...
        if( empty($data['order_id']) ){
            ...
            $data['payment_customer_trans_record_service_card_pay'] = $data['general_pay_money'];//服务卡支付
        ...
        //支付订单
            ...
            $data['payment_customer_trans_record_online_pay'] = !empty($data['general_pay_actual_money']) ? $data['general_pay_actual_money'] : 0;  //在线支付
