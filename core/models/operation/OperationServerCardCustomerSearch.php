...
use core\models\operation\OperationServerCardCustomer;

/**
 * OperationServerCardCustomerSearch represents the model behind the search form about `\core\models\operation\OperationServerCardCustomer`.
 */
