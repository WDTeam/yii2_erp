...
class OperationServiceCardWithCustomer extends \core\models\operation\OperationServiceCardWithCustomer
{
    ...
    {
        return [
            [['service_card_sell_record_id', 'server_card_info_id', 'customer_id', 'server_card_info_scope', 'service_card_with_customer_buy_at', 'service_card_with_customer_valid_at', 'service_card_with_customer_activated_at', 'service_card_with_customer_status', 'created_at', 'updated_at', 'is_del'], 'integer'],
            ...
            [['service_card_sell_record_code', 'service_card_with_customer_code', 'server_card_info_name'], 'string', 'max' => 64],
    ...
    public function attributeLabels()
    {
        return [
            ...
            'server_card_info_id' => Yii::t('app', '服务卡信息id'),
            'service_card_with_customer_code' => Yii::t('app', '服务卡号'),
            'server_card_info_name' => Yii::t('app', '服务卡卡名'),
            'customer_trans_record_pay_money' => Yii::t('app', '实收金额'),
            'server_card_info_value' => Yii::t('app', '卡面金额'),
            ...
            'server_card_info_scope' => Yii::t('app', '使用范围'),
