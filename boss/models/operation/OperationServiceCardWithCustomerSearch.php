...
class OperationServiceCardWithCustomerSearch extends OperationServiceCardWithCustomer
{
    ...
    {
        return [
            [['id', 'service_card_sell_record_id', 'server_card_info_id', 'customer_id', 'server_card_info_scope', 'service_card_with_customer_buy_at', 'service_card_with_customer_valid_at', 'service_card_with_customer_activated_at', 'service_card_with_customer_status', 'created_at', 'updated_at', 'is_del'], 'integer'],
            [['service_card_sell_record_code', 'service_card_with_customer_code', 'server_card_info_name', 'customer_phone'], 'safe'],
            [['customer_trans_record_pay_money', 'server_card_info_value', 'service_card_info_rebate_value', 'service_card_with_customer_balance'], 'number'],
        ];
    }
    ...
    public function search($params)
    {
        ...
        $query->andFilterWhere([
            ...
            'server_card_info_id' => $this->server_card_info_id,
            ...
            'server_card_info_scope' => $this->server_card_info_scope,
        ...
        $query->andFilterWhere(['like', 'service_card_sell_record_code', $this->service_card_sell_record_code])
            ...
            ->andFilterWhere(['like', 'server_card_info_name', $this->server_card_info_name])
