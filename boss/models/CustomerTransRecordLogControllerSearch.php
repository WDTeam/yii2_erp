...
/**
 * CustomerTransRecordLogControllerSearch represents the model behind the search form about `common\models\CustomerTransRecordLog`.
 */
class CustomerTransRecordLogControllerSearch extends CustomerTransRecordLog
{
    public function rules()
    {
        return [
            [['id', 'customer_id', 'order_id', 'order_channel_id', 'pay_channel_id', 'customer_trans_record_mode', 'created_at', 'updated_at', 'is_del'], 'integer'],
            [['customer_trans_record_order_channel', 'customer_trans_record_pay_channel', 'customer_trans_record_mode_name', 'customer_trans_record_online_service_card_on', 'customer_trans_record_transaction_id', 'customer_trans_record_remark', 'customer_trans_record_verify'], 'safe'],
    ...
    public function search($params)
    {
        ...
        $query->andFilterWhere([
            ...
            'customer_trans_record_online_service_card_current_balance' => $this->customer_trans_record_online_service_card_current_balance,
        ...
        $query->andFilterWhere(['like', 'customer_trans_record_order_channel', $this->customer_trans_record_order_channel])
            ->andFilterWhere(['like', 'customer_trans_record_pay_channel', $this->customer_trans_record_pay_channel])
            ->andFilterWhere(['like', 'customer_trans_record_mode_name', $this->customer_trans_record_mode_name])
            ->andFilterWhere(['like', 'customer_trans_record_online_service_card_on', $this->customer_trans_record_online_service_card_on])
