...
class FinancePopOrderSearch extends FinancePopOrder
{
    ...
    {
        return [
            [['id', 'finance_order_channel_id', 'finance_order_channel_title', 'finance_pay_channel_id', 'finance_pay_channel_title', 'finance_pop_order_worker_uid', 'finance_pop_order_booked_time', 'finance_pop_order_booked_counttime', 'finance_pop_order_coupon_id', 'finance_pop_order_order_type', 'finance_pop_order_status', 'finance_pop_order_finance_isok', 'finance_pop_order_order_time', 'finance_pop_order_pay_time', 'finance_pop_order_pay_status', 'finance_pop_order_check_id', 'finance_pop_order_finance_time', 'create_time', 'is_del'], 'integer'],
            [['finance_pop_order_number', 'finance_pop_order_customer_tel', 'finance_pop_order_order2', 'finance_pop_order_channel_order', 'finance_pop_order_pay_title'], 'safe'],
    ...
    public function search($params)
    {
        ...
        $query->andFilterWhere([
            ...
            'finance_order_channel_title' => $this->finance_order_channel_title,
            'finance_pay_channel_id' => $this->finance_pay_channel_id,
            'finance_pay_channel_title' => $this->finance_pay_channel_title,
