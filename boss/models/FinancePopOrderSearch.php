   ...
   **/
    ...
    **/
    public function PopOrderstatus($alinfo,$value,$channelid)
    {
	   ...
	   /*  'order_channel_order_num' => string '0' 
	    'order_money' => string '2' 
	    'order_channel_promote' =>
	    array (size=3)
	    0 => string '5' 
	    1 => string '6' 
	    2 => string '7' 
	    'refund' => string '8' 
	    'function_way' => string '9' */
    ...
    $sumtone=FinancePopOrder::find()->select(['sum(finance_pop_order_sum_money) as sumoney','sum(finance_pop_order_reality_pay) as reality_pay'])
    ...
    ->asArray()->all();
    $suminfodata=$sumtone[0]['sumoney']-$sumttoo[0]['reality_pay'];
