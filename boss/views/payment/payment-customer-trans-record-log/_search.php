...
<div class="payment-customer-trans-record-log-search">
    ...
    <?= $form->field($model, 'payment_customer_trans_record_order_channel') ?>
    ...
    <?php // echo $form->field($model, 'payment_customer_trans_record_service_card_current_balance') ?>

    <?php // echo $form->field($model, 'payment_customer_trans_record_service_card_befor_balance') ?>
