            ...
            $columns = [
                ...
                'buttons' => [
                    'view' => function ($url, $model) {
                        return Html::a('<span>查看</span>', Yii::$app->urlManager->createUrl(['/finance/finance-shop-settle-apply/view', 'id' => $model->id], ['target'=>'_blank']), [
                            'title' => Yii::t('yii', '查看'),'data-pjax'=>'0','target' => '_blank',
                        ]);
                    },
                    'agree' => function ($url, $model) {
                        return Html::a('<span>审核通过</span>', Yii::$app->urlManager->createUrl(['/finance/finance-shop-settle-apply/review', 'id' => $model->id,'review_section'=>$this->params['review_section'],'isFinacePayedConfirm'=>$this->params['isFinacePayedConfirm'],'is_ok'=>1]), [
