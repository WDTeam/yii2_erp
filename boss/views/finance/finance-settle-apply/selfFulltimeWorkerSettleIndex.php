    ...
    <div class="panel panel-info">
     ...
     <div class="panel panel-info">
        ...
        $columns = [
                ...
                'worder_tel',
                'worder_name',
                [ 'header' => Yii::t('app', '阿姨类型'),'content'=>function($model,$key,$index){return $model->getWorkerTypeDes($model->worker_type_id,$model->worker_rule_id);}],
                ...
                [ 'header' => Yii::t('app', '底薪补贴小计'),'content'=>function($model,$key,$index){return 2000;}],
                [ 'header' => Yii::t('app', '任务小计'),'content'=>function($model,$key,$index){return 2000;}],
                [ 'header' => Yii::t('app', '应结合计'),'content'=>function($model,$key,$index){return 2000;}],
                [ 'header' => Yii::t('app', '扣款小计'),'content'=>function($model,$key,$index){return 2000;}],
                [ 'header' => Yii::t('app', '本次应结合计'),'content'=>function($model,$key,$index){return 2000;}],
                'finance_settle_apply_order_cash_money', 
                [ 'header' => Yii::t('app', '本次应付合计'),'content'=>function($model,$key,$index){return 2000;}],
