...
<div class="finance-settle-apply-index">
    <div class="panel panel-info">
        <div class="panel-heading">
            <h3 class="panel-title"><i class="glyphicon glyphicon-search"></i> 自营兼职结算搜索</h3>
        </div>
        <div class="panel-body">
            <?php  echo $this->render('_self_parttime_search', ['model' => $searchModel]); ?>
        </div>
    </div>
     <div class="panel panel-info">
            ...
            'columns' => [
                ...
                'buttons' => [
                    'view' => function ($url, $model) {
                        return Html::a('<span class="glyphicon glyphicon-eye-open"></span>', Yii::$app->urlManager->createUrl(['/finance-settle-apply/self-parttime-worker-settle-view', 'id' => $model->id],['target'=>'_blank']), [
                            'title' => Yii::t('yii', '查看'),
                        ]);
                    },
