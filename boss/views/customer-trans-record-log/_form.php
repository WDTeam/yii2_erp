 ...
 * @var common\models\CustomerTransRecordLog $model
 * @var yii\widgets\ActiveForm $form
 */
?>

<div class="customer-trans-record-log-form">
...
'customer_id'=>['type'=> Form::INPUT_TEXT, 'options'=>['placeholder'=>'Enter 用户ID...']], 
...
'customer_trans_record_mode'=>['type'=> Form::INPUT_TEXT, 'options'=>['placeholder'=>'Enter 交易方式:1消费,2=充值,3=退款,4=赔偿...']], 
