    ...
    <table cellspacing="0" cellpadding="0" border="1">
        ...
        <tr>
            ...
            <td>
                ...
                支付方式：<span><?= Html::encode($model->orderExtPay->orderPayTypeName) ?></span>
                <?= ($model->orderExtPay->pay_channel_id > 0) ? '支付渠道：<span>' . Html::encode($model->orderExtPay->order_pay_channel_name) . '</span>' : ""; ?>
            </td>
            <td>
                <?php
