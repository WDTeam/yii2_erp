...
<?php
    $form = ActiveForm::begin([
        ...
        'action'=>['operate-dimission', 'id'=>$workerModel->id]
    ]);
    ...
    echo '</div>';
    echo $form->field($workerModel, 'worker_dimission_reason');
    echo $form->field($workerModel, 'worker_is_dimission')->radioList([ '1' => '开启','0' => '关闭'], ['inline' => true]);
