    ...
    <ul class="nav nav-tabs nav-stacked">
      ...
      <?php foreach((array)$shopdistrictinfo as $key => $value){ ?>
            ...
            <div class="col-md-10 goodssettinginfo"><?= $shopdistrictname?>
                市场价格：<input type="text" class="operation_goods_market_price" maxlength="" style="width:50px;" placeholder="市场价格" value="<?= empty($settinghopdistrictgoods['operation_goods_market_price'][$shopdistrictid]) ? '' : $settinghopdistrictgoods['operation_goods_market_price'][$shopdistrictid]; ?>" name="shopdistrictgoods[operation_goods_market_price][]" >元
                销售价格：<input type="text" class="operation_goods_price" maxlength="" style="width:50px;" placeholder="销售价格" value="<?= empty($settinghopdistrictgoods['operation_goods_price'][$shopdistrictid]) ? '' : $settinghopdistrictgoods['operation_goods_price'][$shopdistrictid]; ?>" name="shopdistrictgoods[operation_goods_price][]" >元
                最低消费数量：<input type="text" class="operation_goods_lowest_consume" maxlength="" style="width:70px;" placeholder="最低消费数量" value="<?= empty($settinghopdistrictgoods['operation_goods_lowest_consume'][$shopdistrictid]) ? '' : $settinghopdistrictgoods['operation_goods_lowest_consume'][$shopdistrictid]; ?>" name="shopdistrictgoods[operation_goods_lowest_consume][]" >
                ...
                结束服务时间：<input type="text" class="operation_goods_end_time" maxlength="" style="width:50px;" placeholder="结束时间" value="<?= empty($settinghopdistrictgoods['operation_goods_end_time'][$shopdistrictid]) ? '' : $settinghopdistrictgoods['operation_goods_end_time'][$shopdistrictid]; ?>" name="shopdistrictgoods[operation_goods_end_time][]" >
            </div>
        <?php }?>
