...
/**
 * Demo represents the model behind the search form about `\common\models\User`.
 */
class Demo extends User
{
    public function rules()
    {
        return [
            ...
            [['id', 'age', 'from_type', 'when', 'status', 'created_at', 'updated_at', 'study_status', 'study_time', 'notice_status', 'online_exam_time', 'online_exam_score', 'online_exam_mode', 'exam_result', 'operation_time', 'operation_score', 'test_time', 'test_status', 'test_result', 'sign_status', 'user_status'], 'integer'],
        ];
    }
