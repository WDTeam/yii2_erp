define({ "api": [
  ...
  {
    "type": "GET",
    "url": "/order/check-district-goods",
    "title": "[GET] /order/check-district-goods(100%)",
    "description": "<p>检查当前商圈是否已经开通选择的服务 (田玉星)</p> ",
    "name": "actionCheckDistrictGoods",
    "group": "Order",
    "parameter": {
      "fields": {
        "Parameter": [
  ...
  {
    "type": "POST",
    "url": "/worker/set-worker-callback",
    "title": "[POST] /worker/set-worker-callback(100%)",
    "description": "<p>极光推送,记录阿姨回调信息</p> ",
    "name": "actionSetWorkerCallback",
    "group": "Worker",
    "parameter": {
      "fields": {
        "Parameter": [
    ...
    "error": {
      "examples": [
        {
          "title": "Error-Response:",
          "content": "HTTP/1.1 200 worker Not Found\n{\n  \"code\": 0,\n  \"msg\": \"操作删除失败\",\n  \"ret\": {},\n \"alertMeg\": \"操作删除失败\"\n }",
          "type": "json"
        }
      ]
    },
